...
function createUserTest() {
    ...
    //        password: "Apple*83"
    //    },
    //    userPrincipalName: "garfieldlynns4@" + TENANT_DOMAIN,
    ...
    //        password: "Dragon*83"
    //    },
    //    userPrincipalName: "sandrawoosan4@" + TENANT_DOMAIN,
    ...
    //    },
    //    userPrincipalName: config:getAsString("ad.users.user2.username"),
    //};
    //
...
//    };
//     AdClientError? deleteError = adClient->deleteUser(invalidUser.userPrincipalName);
...
function deleteTestUsersTest()  {
    ...
    //    checkpanic adClient->deleteUser(createdUser1.userPrincipalName);
    //} else {
    ...
    //    checkpanic adClient->deleteUser(createdUser2.userPrincipalName);
    //} else {
    ...
    //    checkpanic adClient->deleteUser(createdUser3.userPrincipalName);
    //} else {
    //    test:assertFail("Test user3 was not created");
    //}
    //
    //checkpanic adClient->deleteUser("foobar@BallerinaConnectorTestAd.onmicrosoft.com");
    //checkpanic adClient->deleteUser("garfieldlynns1@BallerinaConnectorTestAd.onmicrosoft.com");
    //checkpanic adClient->deleteUser("garfieldlynns2@BallerinaConnectorTestAd.onmicrosoft.com");
    //checkpanic adClient->deleteUser("garfieldlynns3@BallerinaConnectorTestAd.onmicrosoft.com");
    //checkpanic adClient->deleteUser("sandrawoosan@BallerinaConnectorTestAd.onmicrosoft.com");
    //
    //checkpanic adClient->deleteUser("sandrawoosan2@BallerinaConnectorTestAd.onmicrosoft.com");
    //checkpanic adClient->deleteUser("sandrawoosan3@BallerinaConnectorTestAd.onmicrosoft.com");
}
